...
List<GetPackedByListResponse> getPackedByListResponseFromJson(String str) {
  try {
    final decoded = json.decode(str);
    if (decoded is List) {
      return List<GetPackedByListResponse>.from(
        decoded.map(
          (x) => GetPackedByListResponse.fromJson(x as Map<String, dynamic>),
        ),
      );
    }
    return [];
...
String getPackedByListResponseToJson(List<GetPackedByListResponse> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class GetPackedByListResponse {
  String status;
  String message;
  String documentPath;
  List<PackedByListData> data;

  GetPackedByListResponse({
  ...
  factory GetPackedByListResponse.fromJson(Map<String, dynamic> json) {
    return GetPackedByListResponse(
      status: json['status'] as String? ?? '',
      message: json['message'] as String? ?? '',
      documentPath: json['document_path'] as String? ?? '',
      data: json['data'] is List
          ? List<PackedByListData>.from(
              (json['data'] as List).map(
                (x) => PackedByListData.fromJson(x as Map<String, dynamic>),
              ),
            )
          : [],
    );
...
class PackedByListData {
  ...
  factory PackedByListData.fromJson(Map<String, dynamic> json) {
    return PackedByListData(
