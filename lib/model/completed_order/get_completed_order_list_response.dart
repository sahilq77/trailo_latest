...
class GetCompletedOrderListResponse {
  ...
  String message;
  String documentPath;
  List<CompletedOrderData> data;

  GetCompletedOrderListResponse({
  ...
  factory GetCompletedOrderListResponse.fromJson(Map<String, dynamic> json) {
    return GetCompletedOrderListResponse(
      status: json['status'] as String? ?? '',
      message: json['message'] as String? ?? '',
      documentPath: json['document_path'] as String? ?? '',
      data: json['data'] is List
          ? List<CompletedOrderData>.from(
              (json['data'] as List).map(
                (x) => CompletedOrderData.fromJson(x as Map<String, dynamic>),
              ),
            )
          : [],
    );
