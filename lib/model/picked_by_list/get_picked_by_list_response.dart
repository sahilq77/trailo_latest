...
List<GetPickedByListResponse> getPickedByListResponseFromJson(String str) {
  try {
    final decoded = json.decode(str);
    if (decoded is List) {
      return List<GetPickedByListResponse>.from(
        decoded.map(
          (x) => GetPickedByListResponse.fromJson(x as Map<String, dynamic>),
        ),
      );
    }
    return [];
...
String getPickedByListResponseToJson(List<GetPickedByListResponse> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class GetPickedByListResponse {
  String status;
  String message;
  String documentPath;
  List<PickedByListData> data;

  GetPickedByListResponse({
  ...
  factory GetPickedByListResponse.fromJson(Map<String, dynamic> json) {
    return GetPickedByListResponse(
      status: json['status'] as String? ?? '',
      message: json['message'] as String? ?? '',
      documentPath: json['document_path'] as String? ?? '',
      data: json['data'] is List
          ? List<PickedByListData>.from(
              (json['data'] as List).map(
                (x) => PickedByListData.fromJson(x as Map<String, dynamic>),
              ),
            )
          : [],
    );
...
class PickedByListData {
  ...
  factory PickedByListData.fromJson(Map<String, dynamic> json) {
    return PickedByListData(
