...
class CheckVendorInvoiceNumberController extends GetxController {
  ...
  Future<void> verifyInvoiceNumber({
    ...
    try {
      final jsonBody = {"invoice_number": invNo, "inward_id": inwardID};

      isLoading.value = true;

      List<Object?>? list = await Networkcall().postMethod(
        Networkutility.checkVenderInvoiceNumberApi,
        Networkutility.checkVenderInvoiceNumber,
        jsonEncode(jsonBody),
        Get.context!,
      );

      if (list != null && list.isNotEmpty) {
        List<CheckVenderInvoiceNumberResponse> response = List.from(list);
