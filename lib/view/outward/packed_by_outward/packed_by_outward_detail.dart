                ...
                Expanded(
                  child: ListView(
                    ...
                    children: [
                      ...
                      packedBy.orderCopy != null && packedBy.orderCopy!.isNotEmpty
                          ? _viewButton('Order Copy', () {
                              _handleViewDocument(packedBy.orderCopy, 'Order Copy');
                            })
                          : _buildDetailRow('Order Copy', '-'),
                      packedBy.invoiceCopyNew != null && packedBy.invoiceCopyNew!.isNotEmpty
                          ? _viewButton('Invoice Copy', () {
                              _handleViewDocument(packedBy.invoiceCopyNew, 'Invoice Copy');
                            })
