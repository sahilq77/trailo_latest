...
class _CompletedOrderListState extends State<CompletedOrderList> {
  final CompletedOrderListController controller = Get.put(
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: Obx(() {
          ...
          if (controller.completedOrderList.isEmpty &&
              !controller.isLoadingMore.value) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, int index) {
              if (index == controller.completedOrderList.length) {
              ...
              var outward = controller.completedOrderList[index];
              return GestureDetector(
                onTap: () {
                  Get.toNamed(
                    AppRoutes.completedorderdetail,
                    arguments: {
                      "completed_detail": outward,
                      "sr_no": "${index + 1}",
                    },
                  );
                },
