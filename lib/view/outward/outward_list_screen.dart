...
class OutwardListScreen extends StatefulWidget {
  ...
  @override
  _OutwardListScreenState createState() => _OutwardListScreenState();
}
      ...
      child: Scaffold(
        ...
        body: RefreshIndicator(
          ...
          child: Obx(() {
            ...
            if (controller.outwardList.isEmpty &&
                !controller.isLoadingMore.value) {
            ...
            return ListView.builder(
              ...
              itemCount:
                  controller.outwardList.length +
                  (controller.hasMoreData.value ||
                          controller.isLoadingMore.value
                      ? 1
                      : 0),
              itemBuilder: (context, int index) {
                if (index == controller.outwardList.length) {
                ...
                var outward = controller.outwardList[index];
                return GestureDetector(
                  onTap: () {
                    Get.toNamed(
                      AppRoutes.outwarddetail,
                      arguments: {
                        "outward_detail": outward,
                        "sr_no": "${index + 1}",
                      },
                    );
                  },
