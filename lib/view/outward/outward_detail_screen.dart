                ...
                return RefreshIndicator(
                  ...
                  child: ListView(
                    children: [
                      ...
                      controller.outwardDetail[0].orderCopy != null && controller.outwardDetail[0].orderCopy!.isNotEmpty
                          ? _viewButton('Order Copy', () {
                              try {
                                final filePath = controller.outwardDetail[0].orderCopy.toString().toLowerCase();
                                final url = '${controller.url.value}${controller.outwardDetail[0].orderCopy}';
                      ...
                      controller.outwardDetail[0].invoiceCopyNew != null && controller.outwardDetail[0].invoiceCopyNew!.isNotEmpty
                          ? _viewButton('Invoice Copy', () {
                              try {
                                final filePath = controller.outwardDetail[0].invoiceCopyNew.toString().toLowerCase();
                                final url = '${controller.url.value}${controller.outwardDetail[0].invoiceCopyNew}';
                                if (filePath.endsWith('.pdf')) {
                                  Get.toNamed(AppRoutes.viewpdf, arguments: url);
                                } else if (filePath.endsWith('.jpg') ||
                                    filePath.endsWith('.png') ||
