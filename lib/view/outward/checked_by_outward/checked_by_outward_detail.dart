            ...
            Expanded(
              child: ListView(
                children: [
                  ...
                  chekcedBy!.orderCopy != null && chekcedBy!.orderCopy!.isNotEmpty
                      ? _viewButton('Order Copy', () {
                          try {
                            final filePath = chekcedBy!.orderCopy.toString().toLowerCase();
                            final url = '${controller.url.value}${chekcedBy!.orderCopy}';
                  ...
                  chekcedBy!.invoiceCopyNew != null && chekcedBy!.invoiceCopyNew!.isNotEmpty
                      ? _viewButton('Invoice Copy', () {
                          try {
                            final filePath = chekcedBy!.invoiceCopyNew.toString().toLowerCase();
                            final url = '${controller.url.value}${chekcedBy!.invoiceCopyNew}';
                            if (filePath.endsWith('.pdf')) {
                              Get.toNamed(AppRoutes.viewpdf, arguments: url);
                            } else if (filePath.endsWith('.jpg') ||
                                filePath.endsWith('.png') ||
