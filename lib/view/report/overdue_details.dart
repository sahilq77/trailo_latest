            ...
            Expanded(
              child: ListView(
                children: [
                  ...
                  _buildDetailRow(
                    'Customer Name',
                    overdue!.customerName.isNotEmpty
                        ? overdue!.customerName
                        : "N/A",
                  ),
                  _buildDetailRow(
                    'Issue Name',
                  ...
                  _viewButton('Order Copy', () {
                    try {
                      if (overdue == null || overdue!.orderCopy == null) {
                        print('Error: overdue or lrCopy is null');
                        // Optionally show a snackbar or dialog to user
                        // Get.snackbar('Error', 'No document available to view');
                        return;
                      }

                      final filePath = overdue!.orderCopy
                          .toString()
                          .toLowerCase();
                      final url =
                          '${controller.url.value}${overdue!.orderCopy}';
                  ...
                  _viewButton('Invoice Copy', () {
                    try {
                      if (overdue == null || overdue!.invoiceCopyNew == null) {
                        print('Error: overdue or lrCopy is null');
                        // Optionally show a snackbar or dialog to user
                        //Get.snackbar('Error', 'No document available to view');
                        return;
